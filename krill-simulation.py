...
def calc_krill_biomass(survey_area_width, survey_area_length, edsu_width, detected_width, input_data):
...
for i in range(0, n_runs):
    run_function = calc_krill_biomass(survey_area_width=565e3, survey_area_length=210e3, detected_width=50, edsu_width=2000, input_data=example_p)
